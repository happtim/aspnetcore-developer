...
host.OnStepError += (workflow, context, exception) =>
{
	Console.WriteLine($"全局错误处理: 工作流 {workflow.WorkflowDefinitionId} 步骤 {context.Id} 发生错误: {exception.Message}");
};
