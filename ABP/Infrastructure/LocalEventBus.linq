...
public class TestWorker : AsyncPeriodicBackgroundWorkerBase
{
	...
	{
		ILocalEventBus localEventBus = workerContext.ServiceProvider.GetRequiredService<ILocalEventBus>();
		await localEventBus.PublishAsync(new GettingStarted { Value = DateTime.Now.ToString() });
	}
}

public class MyHandler
		: ILocalEventHandler<GettingStarted>,
